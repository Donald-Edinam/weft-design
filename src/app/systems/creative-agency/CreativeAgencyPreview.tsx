  ...
  return (
    <div className={clsx("min-h-screen selection:bg-[#E63B2E] selection:text-white pt-[48px]", playfair.variable)}>
      ...
      {/* 
        ...
        ========================================================================
      */}
      <div className="fixed top-0 left-0 w-full h-[48px] bg-[#000000] border-b border-white/10 flex items-center justify-between px-[16px] xl:px-[24px] z-[200] font-sans">
        <div className="flex items-center gap-[16px]">
          <span className="font-[600] text-white text-[14px]">Creative Agency</span>
        ...
        <div className="flex items-center gap-[24px] text-[13px] font-[500]">
          <Link href="/systems/creative-agency/DESIGN.md" className="flex items-center gap-[6px] text-[#EAB308] hover:text-[#CA8A04] transition-colors">
